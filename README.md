...
- Dataset bias: Overly rely on Western platforms (Yelp, TripAdvisor) and ignore dominant local sources (Google Maps) (Darraz et al., 2025; Vemula et al., 2024)
...
# Research Objective
This study aims to develop an AI-driven strategic intelligence framework that leverages aspect-based sentiment analysis on Google Maps Reviews data, to extract culturally relevant dining determinants and provide actionable insights for gastronomy tourism stakeholders in Malaysia. 
...
- **Weak labels (silver standard) for aspect supervision:** [Dataset/silver_std.csv](Dataset/silver_std.csv)
...
- Metrics: [Modelling/results/sentiment_training_metrics_after_filtering.json](Modelling/results/sentiment_training_metrics_after_filtering.json), [Modelling/results/sentiment_gold_evaluation.json](Modelling/results/sentiment_gold_evaluation.json)
...
|---:|---|---|---|
| 1 | [Phase_1a_Data_Collection/1. DataCollection.ipynb](Phase_1a_Data_Collection/1.%20DataCollection.ipynb) | Collect Google Maps place + review data (macro breadth data). | Raw CSV exports. |
| 2 | [Phase_1b_Data_Preparation/1. BasicDataCleaning.ipynb](Phase_1b_Data_Preparation/1.%20BasicDataCleaning.ipynb) | Basic text/data cleaning for noisy, code-switched reviews. | [Dataset/clean_data1.pkl](Dataset/clean_data1.pkl)| 
| 3 | [Phase_1b_Data_Preparation/2. AttributEnrichment.ipynb](Phase_1b_Data_Preparation/2.%20AttributEnrichment.ipynb) | Attribute enrichment and final cleaning for downstream labeling/training. | [Dataset/clean_data2.pkl](Dataset/clean_data2.pkl) |
| 4 | [Phase_2_Culturally_Aware_Aspect_Categorization/1. SilverStandardDatasetCreation.ipynb](Phase_2_Culturally_Aware_Aspect_Categorization/1.%20SilverStandardDatasetCreation.ipynb) | Create weak sentiment labels from star ratings (1-2 → negative, 4-5 → positive) with VADER consistency filtering. | [Dataset/silver_std.pkl](Dataset/silver_std.pkl) | 
| 5 | [Phase_2_Culturally_Aware_Aspect_Categorization/2. AspectCategorization.ipynb](Phase_2_Culturally_Aware_Aspect_Categorization/2.%20AspectCategorization.ipynb) | Build culturally-aware aspect dictionary for aspect categorization, paired with fuzzy string matching and segment-level VADER consistency filtering. | [Dataset/aspect_categorization_before_filter.pkl](Dataset/aspect_categorization_before_filter.pkl), [Dataset/aspect_categorization_after_filtering.pkl](Dataset/aspect_categorization_after_filtering.pkl) |
| 6 | [Phase_2_Culturally_Aware_Aspect_Categorization/3. GoldStandardDatasetCreation.ipynb](Phase_2_Culturally_Aware_Aspect_Categorization/3.%20GoldStandardDatasetCreation.ipynb) | Stratified sampling of 500 reviews (250 positive + 250 negative) and create Excel template for manual aspect & sentiment annotation. | [Dataset/Gold_Standard_Labeling_Task.xlsx](Dataset/Gold_Standard_Labeling_Task.xlsx) |
| 7 | [Phase_2_Culturally_Aware_Aspect_Categorization/4a. AspectDictionaryEvaluatioonOnGoldStandard.ipynb](Phase_2_Culturally_Aware_Aspect_Categorization/4a.%20AspectDictionaryEvaluatioonOnGoldStandard.ipynb) | Evaluate aspect dictionary categorization performance against manually-annotated gold standard test set. | N/A (analysis notebook) |
| 8 | [Phase_2_Culturally_Aware_Aspect_Categorization/4b. XLM_RoBERTa_Aspect_Categorization.ipynb](Phase_2_Culturally_Aware_Aspect_Categorization/4b.%20XLM_RoBERTa_Aspect_Categorization.ipynb) | Train XLM-RoBERTa to categorize aspects and evaluate the performance against manually-annotated gold standard test set. | [Modelling/models/xlm_roberta_aspect_categorization_best.pt](Modelling/models/xlm_roberta_aspect_categorization_best.pt), [Modelling/results/aspect_training_metrics.json](Modelling/results/aspect_training_metrics.json), [Modelling/results/aspect_gold_evaluation.json](Modelling/results/aspect_gold_evaluation.json) |
| 9 | [Phase_3_Sentiment_Analysis/1. Traditional_ML.ipynb](Phase_3_Sentiment_Analysis/1.%20Traditional_ML.ipynb) | Train and evaluate classical ML baselines (VADER + ML classifiers). |  |
| 10 | [Phase_3_Sentiment_Analysis/2b. XLM_RoBERTa_Training_AfterFiltering.ipynb](Phase_3_Sentiment_Analysis/2b.%20XLM_RoBERTa_Training_AfterFiltering.ipynb) | Train XLM-RoBERTa for sentiment classification and evaluate the performance against manually-annotated gold standard test set. | [Modelling/models/xlm_roberta_absa_best_after_filtering.pt](Modelling/models/xlm_roberta_absa_best_after_filtering.pt), [Modelling/results/sentiment_training_metrics_after_filtering.json](Modelling/results/sentiment_training_metrics_after_filtering.json), [Modelling/results/sentiment_gold_evaluation.json](Modelling/results/sentiment_gold_evaluation.json) |
| 11 | [Phase_4_Strategic_Visualization/1. Macro_data_sentiments.ipynb](Phase_4_Strategic_Visualization/1.%20Macro_data_sentiments.ipynb) | Generate macro-level sentiment predictions (segment-level). | [Dataset/Output/segment_level_predictions.csv](Dataset/Output/segment_level_predictions.csv) |
| 12 | [Phase_4_Strategic_Visualization/2. Macro_data_aggregations.ipynb](Phase_4_Strategic_Visualization/2.%20Macro_data_aggregations.ipynb) | Aggregate predictions to state/category/restaurant + Kano model inputs. | [Dataset/Output/kano_model_input.csv](Dataset/Output/kano_model_input.csv), [Dataset/Output/state_level_summary.csv](Dataset/Output/state_level_summary.csv), [Dataset/Output/category_level_summary.csv](Dataset/Output/category_level_summary.csv), [Dataset/Output/state_category_summary.csv](Dataset/Output/state_category_summary.csv), [Dataset/Output/restaurant_aspect_aggregates.csv](Dataset/Output/restaurant_aspect_aggregates.csv) |
| 13 | [Phase_4_Strategic_Visualization/3. Micro_data_sentiments.ipynb](Phase_4_Strategic_Visualization/3.%20Micro_data_sentiments.ipynb) | Generate micro-level sentiment predictions (full history for selected restaurants). | [Dataset/MicroDataset/final_micro.csv](Dataset/MicroDataset/final_micro.csv) |
| 14 | [Phase_4_Strategic_Visualization/4. STAR_schema_data_preparation.ipynb](Phase_4_Strategic_Visualization/4.%20STAR_schema_data_preparation.ipynb) | Prepare STAR-schema tables for the Power BI dashboard. | [Dataset/PowerBI_input/MacroSentiments.csv](Dataset/PowerBI_input/MacroSentiments.csv), [Dataset/PowerBI_input/MicroSentiments.csv](Dataset/PowerBI_input/MicroSentiments.csv), [Dataset/PowerBI_input/RestaurantMetadata.csv](Dataset/PowerBI_input/RestaurantMetadata.csv) |
| 15 | [Phase_4_Strategic_Visualization/5. Statistical Testing.ipynb](Phase_4_Strategic_Visualization/5.%20Statistical%20Testing.ipynb) | Statistical hypothesis testing: validate relationships between price range and (1) overall rating, (2) review volume, (3) weighted sentiment score using Kruskal-Wallis + Dunn's post-hoc tests; test geographic clustering of expensive restaurants using Chi-Square test. | N/A (analysis notebook) |
